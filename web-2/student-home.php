								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p><?=$_SESSION['name']?><span>Student</span></p>
										 </div>
...
<br><br><br>
 ...
 <?php 
              ...
              $sql = "SELECT ques_id,solved,difficulty,domain,ques_header,no_of_attempts FROM question";
...
echo "<div id='feed-1552957' class='feed-id'><div class='feed feed__challenge'><div class='row feed__header clearfix'><div class='span11 reason-container'>
      <div class='reason'>
        
  <i class='icon-code pull-left'>";
echo $row['ques_id'];
 echo " </i>

<p class='inline-block reason-text'>";

echo "</p>
   </div>
    </div>
    <div class='span5 itc-container itc-header'>
      <p><span class='metric-name'>Difficulty: ";
        echo $row['difficulty'];
   echo"   </span></p>
    </div>
  </div>
  <div class='feed__content clearfix mlB mlR'>
    <h4 class='primary-heading mmB'>
  <a class='challenge backbone'>";
      echo $row['ques_header'];
 echo" </a>
</h4>
<span class='primary-text inline-block'>
</span>
<div class='itc-container itc-footer'>
    <p>
    </p>
</div>
  </div>
  <div class='feed__footer clearfix'>";
  echo 'Successful Submissions: '.$row[solved];
  echo "  <div class='ctas-container pull-right'>
          <a class=' primary-cta  backbone  btn btn-green btn-flat mlL' href='./compiler-new.php?ques_id=".$row['ques_id'];
          echo"' data-track-target='cta1' data-track-value='Solve Challenge'>Solve Challenge</a>
    </div>
  </div>
</div>
</div>";
