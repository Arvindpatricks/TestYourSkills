...
<html>
<head>
<title>Crafy Designers Admin Panel</title>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">College Validity</h3>
					 <div class="xs tabls">
		...
		<!--footer section start-->
			<footer>
				<p>&copy 2015 Crafty Desginers Admin Panel. All Rights Reserved</p>			</footer>
        <!--footer section end-->
	</section>
