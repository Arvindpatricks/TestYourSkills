 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html">Student<span>Registration</span></a></h1>
			</div>
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1" align="center">Registration</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="studentregister.php" method="post">
								...
								<div class="form-group" >
									...
									<div class="col-sm-8"><select name="college" id="college" class="form-control1">
					...
					<!-- 		<div class="form-group" align="center>
						  ...
						  <div class="panel-footer">
							<div class="row">
								...
								<input type="submit" class="btn-success btn" value="Register">
