...
$sql = "SELECT * FROM college where hoiid='".$tysid."'";
$sql1 ="SELECT tysid FROM staffs where colg_id='".$tysid."';";
$sql2 ="SELECT tysid FROM staffs where colg_id='".$tysid."' and last_active='".date("Y-m-d")."';";
$result1 = $conn->query($sql1);
$result2 = $conn->query($sql2);

$result = $conn->query($sql);
$noofstaffs=mysql_num_rows($result1);
$active_staffs=mysql_num_rows($result2);
$staffs_active_per = ($active_staffs/$noofstaffs)*100;
...
?>
<title>TestYourSkills.com | Home</title>
								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p><?=$_SESSION['name']?><span>College Admin</span></p>
										 </div>
